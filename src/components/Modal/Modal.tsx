  ...
  return (
    <>
      <div className="container mx-auto py-0">
        ...
        <div
          className={`z-50 fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-dark/90 px-4 py-5 ${
            open ? "block" : "hidden"
          }`}
        >
          <div
            ...
            className=" w-full max-w-[870px] h-full max-h-[870px] rounded-[20px] bg-orange-200 px-8 py-12 text-center dark:bg-dark-2 md:px-[70px] md:py-[60px]"
          >
